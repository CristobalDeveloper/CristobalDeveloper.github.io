...
function viewDataUpdate(name,description,key){
    ...
    '<input type="text" maxlength="20" id="nameEdit" class="form-control" placeholder="Name" value='+name+'>'+
    '</div>'+
    '<div class="form-group">'+
    '<textarea maxlength="40" placeholder="DescriptionEdit" class="form-control" id="descEdit">'+description+'</textarea>'+
    '</div>';
